...
<body>
    ...
    <header id="header" class="fixed-top">
        <div id="mySidenav" class="sidenav">
            ...
            <a href="dispatch.html">Dispatch Post</a>
    ...
    <div id="main">
        <marquee style="margin-bottom:40px;" class="marquee" behavior="alternate">Welcome EMPLOYEE !!!</marquee>
        <a href="dispatch.html"><img src="../../admin/img/back.png" alt="Go Back"></a> <br> <a href="dispatch.html"><h4 style="font-size:20px; margin:-25px 0px -10px 40px;" >Go Back</h4></a> 
        ...
        <?php
            ...
            $sql1 = "UPDATE posts SET status='dispatched', empid='$empid',disdate=NOW() WHERE postno='$postno'" ;
            $result1 = $conn->query($sql1);
            //header('Location: disno.php?postno=10'); 
            sleep(2);
            echo "<script> alert('Selected Post has been dispatched! Refresh to see the changes!!');</script>" ; 
        ...
        <br>
        <form method="get"">
            <input class="w3-input w3-animate-input" style="display:inline; width:10%; max-width:17%" type="text" id="postno" name="postno" placeholder="Enter Post No.">
            <input id="submit" name="submit" type="submit" value="Dispatch" class="submit">
        </form>
    ...
    <footer id="footer">
        <div class="container">
            ...
            <div class="credits">Designed by <a href="https://google.com/" target="_blank">Lvly Pavi</a>
            </div>
        </div>
    </footer>
    <!-- End Footer -->
