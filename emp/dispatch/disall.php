...
<body>
    ...
    <div id="main">
        ...
        <h3 style="text-align:center;" class="img-fluid">Details about ALL Posts...</h3> <br>
        ...
        <?php
            ...
            //postno, bookdate, uid, fname, faddress, fphoneno, tname, taddress, tphoneno, empid, disdate, status
